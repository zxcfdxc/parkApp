...
//控制硬件返回按钮是否触发，默认false
  ...
  registerBackButtonAction(tabRef: Tabs): void {
    ...
    this.platform.registerBackButtonAction(() => {
      ...
      //控制modal、系统自带提示框
      let overlay = this.appCtrl._appRoot._overlayPortal.getActive() || this.appCtrl._appRoot._modalPortal.getActive()||this.appCtrl._appRoot._loadingPortal.getActive();
      if(overlay) {
          overlay.dismiss();
          return;
      }
